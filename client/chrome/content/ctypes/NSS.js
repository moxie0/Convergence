...
NSS.initialize = function(nssPath) {  
  ...
  // NSS.types.SSL_AuthCertificate = ctypes.FunctionType(ctypes.default_abi, 
  //   					      ctypes.int32_t, 
  //   					      [ctypes.voidptr_t,
  ...
  NSS.lib = {
    ...
    // SSL_ConfigMPServerSIDCache : sharedLib.declare("SSL_ConfigMPServerSIDCache",
    // 						   ctypes.default_abi,
    // 						   ctypes.int,
    // 						   ctypes.int,
    // 						   ctypes.uint32_t,
